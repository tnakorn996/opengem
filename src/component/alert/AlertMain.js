...
export default function AlertMain({
      ...
      alertmainrender: () => {
        if(alertmaindata.length > 0) {
          return appCaptionRenderTwo({
            data: alertMainActionTwo({
              alertmainstatus: `success`,
              alertmaintitle: `Successfully created voucher`,
        ...
        if(alertmaindata.length === 0) {
          return appCaptionRenderTwo({
            data: alertMainActionTwo({
              alertmainstatus: `success`,
              alertmaintitle: `Successfully deleted voucher`,
              alertmaindata: [{alertmainsubtitle: `The customer has claimed their voucher.`}] 
            }) 
          })
        }
  ...
  const alertmain = [
    {
      alertmainid: `couponcaption`,
      alertmainref: couponcaption,
    },
    {
  ...
  if(typeof alertmaindata === 'undefined') return `Loading...`
